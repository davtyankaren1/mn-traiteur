...
import { User, Phone, MapPin, MessageSquare, ArrowLeft, ArrowRight } from "lucide-react"
...
export default function CustomerInfoStep({
  ...
  const validateForm = () => {
    ...
    } else if (!/^\+374\s?\d{2}\s?\d{3}\s?\d{3}$/.test(customerInfo.phone.replace(/\s/g, ""))) {
  ...
  return (
    <div className="p-6 h-full flex flex-col overflow-hidden">
      <div className="text-center mb-4">
        <h3 className="text-xl font-semibold text-gray-900 mb-2" style={{ fontFamily: "Arial" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              className={`transition-all duration-200 ${
                errors.name ? "border-red-500 focus:border-red-500" : "focus:border-red-600"
              }`}
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              onChange={handleInputChange}
              className={`transition-all duration-200 ${
                errors.phone ? "border-red-500 focus:border-red-500" : "focus:border-red-600"
              }`}
        ...
        <div className="space-y-1">
          ...
          <Textarea
            ...
            className={`transition-all duration-200 resize-none ${
              errors.address ? "border-red-500 focus:border-red-500" : "focus:border-red-600"
            }`}
